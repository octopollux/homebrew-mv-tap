class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "d0a400d698f88f007028742f6ffa665dc78a3516a155b7575bc629f04af383e1"
    end
  end
