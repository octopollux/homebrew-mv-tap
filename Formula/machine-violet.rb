class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "18209f00043263a87db964e6e9b842f6fb1869f01498fe0b0221dde11f042f5c"
    end
  end
