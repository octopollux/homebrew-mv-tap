class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "50eb0e54704a4c7ffb73a4ff05c84856e2e4da634a8d0badf13e24d5e1157356"
    end
  end
