class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "298d45a6a59e41d1a73f9b5097cc1810673fb27fc9386c63dedf5d8e27ccc94a"
    end
  end
