class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "403be5bca72ca095b037a6a723a5db138891f3b82b57b3c718e341dbae1f4da0"
    end
  end
