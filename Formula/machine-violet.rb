class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "0d94f5ff79aac55f46a5d966d17a18dca6f4e3a75d17bdf9fce36225750c3ff7"
    end
  end
