class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "bdc20157e0103be1d18acda6a2d3611f46705cb8480e1be0dbac924563cf0209"
    end
  end
