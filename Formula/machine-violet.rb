class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "aeedc682f16b2acec581ed36dba191fc8e2b6a846d2afe26fecc930d8d3a8aa3"
    end
  end
