class MachineViolet < Formula
  ...
  on_linux do
    on_intel do
      ...
      sha256 "f75420b5947180f33368c8ab5eeb9afb6bc32a7967f958f66be459120b8b898e"
    end
  end
